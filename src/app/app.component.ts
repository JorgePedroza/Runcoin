...
export class AppComponent implements AfterViewInit {
  ...
  async aprovarUsoDeTokens(): Promise<void> {
    const addressAprobada = this.web3s.accounts[0];
    const cantidadTokens = 2000000000000;
  ...
  async transferirTokensAprobados(): Promise<void> {
    ...
    const addressDestinoFrom = "0xf950C1E61a927221B144c83201Bc4D5D3bCd5d8B";
    const tokensEnviadosFrom =  20000000;
    ...
    this.web3s.contrato.methods.transferFrom(addressRemitenteFrom, addressDestinoFrom, tokensEnviadosFrom).send({ from: this.web3s.accounts[0] })
      ...
      .catch((error: any) => {
        console.log(error);
        this.resultTransferenciaAprobada = "Error ";
      });
  }
  ...
  scrollToBottom() {
   ...
   //   this.tokensRNC+= this.contador2;
    ...
    reset() {
      this.tokensRNC=  this.tokensRNC + this.contador2;
      this.contador2 = 0;
      this.hours = 0;
      this.minutes = 0;
      this.seconds = 0;
